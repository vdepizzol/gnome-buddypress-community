	...
	<div class="activity-content">
		...
		<div class="activity-header">
    		...
    		if ( ( is_user_logged_in() && $activities_template->activity->user_id == $bp->loggedin_user->id ) || $bp->is_item_admin || $bp->loggedin_user->is_super_admin ) {
		        echo '<span class="right" title="Delete activity">' . bp_get_activity_delete_link() . '</span>';
	        }
		...
		<div class="activity-meta">
			 ...
			 * Time since
			 */
			echo '<a class="time-since" href="' . bp_activity_get_permalink( $activities_template->activity->id, $activities_template->activity ) . '">' . sprintf( __( '%s ago', 'buddypress' ), bp_core_time_since( $activities_template->activity->date_recorded ) ) . '</a>';
